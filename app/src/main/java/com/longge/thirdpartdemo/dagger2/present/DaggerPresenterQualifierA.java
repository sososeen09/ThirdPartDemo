...
import com.longge.thirdpartdemo.dagger2.di.QualifierA;
...
public class DaggerPresenterQualifierA {
    ...
    @Inject
    public DaggerPresenterQualifierA(@QualifierA UserManager userManager) {
